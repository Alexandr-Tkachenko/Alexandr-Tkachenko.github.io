...
photoHeight();window.onresize=photoHeight;$('.count-number').counterUp({time:3000,});setTimeout(function(){new WOW().init()},500);var isIE=!1||!!document.documentMode;if(isIE){var body=document.getElementsByTagName("body")[0];var link=document.createElement("link");link.rel="stylesheet";link.href="css/ie.css";body.appendChild(link)}})
